...
public class AppointmentDatabase {
    ...
    /**
     * Creates a new row in the City table in the database representing a new city.
     * First, the method verifies that the city does not already exist, and if it does
     * throws an exception. Else, the method inserts the new city into the database,
     * and then creates a new instance of a City object based on the information
     * returned from the insert, which includes the autogenerated city id.
     * 
    ...
    public static City addCityToDB(String name, Country country) throws Exception {
        ...
        if(DBQuery.recordExistsInDatabase(City.TABLE_NAME, filterData) != -1) {
            // TODO: Handle this exception with an alert.
        ...
        return City.createCityInstanceFromHashMap(dataMap);
    }
